...
public class MinionFleeBehavior : MinionEnemyBehavior
{
    public override void ExecuteBehavior()
    {
        Vector3 moveDirection = (this.enemy.creatureRb.position - this.enemy.playerTarget.creatureRb.position).normalized;
